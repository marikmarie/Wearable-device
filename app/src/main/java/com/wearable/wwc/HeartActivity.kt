...
class HeartActivity : AppCompatActivity() {
    ...
    fun onMeasureButtonClick(view: View) {
        val currentHeartRate = generateRandomHeartRate() // Replace with your heart rate calculation or value
    ...
    private fun updateHeartRateDisplay(heartRate: Int) {
        heartRateDisplay.text = "Heart Rate: $heartRate"
    }
    ...
    private fun generateRandomHeartRate(): Int {
        // Replace with your heart rate calculation or value
