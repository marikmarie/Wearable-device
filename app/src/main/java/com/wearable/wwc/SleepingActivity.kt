...
class SleepingActivity : AppCompatActivity() {
    ...
    private lateinit var sleepingPatternDisplay: TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sleepingpattern)

        graphContainer = findViewById(R.id.graphContainer)
        sleepingPatternDisplay = findViewById(R.id.sleepingPatternDisplay)
    }
    ...
    fun onAdvisoryButtonClick(view: View) {
        ...
        val intent = Intent(this, SleepingadvActivity::class.java)
    ...
    private fun updateSleepingPatternDisplay(pattern: String) {
        sleepingPatternDisplay.text = "Sleeping pattern: $pattern"
    }
